...
save = False
dir_path = os.getcwd() + "/results/infomax/"
print(dir_path)
...
# xinit =  Xinit[0]#[-0.7815724015256085, 0.7432973423368283]
print(xinit)
...
robot = IM(x0=x0, wslim=lim, ts=dt, target_dist=model)
...
for iter_step in range(num_steps):
    ### Plan in KL-Erg ###
    state = robot.step(num_target_samples= 50, max_dist=0.1)
